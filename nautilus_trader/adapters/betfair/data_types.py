...
class BetfairTicker(Data):
    ...
    def from_dict(cls, values: dict):
        return cls(
            ...
            starting_price_near=(values["starting_price_near"] if values["starting_price_near"] else None),
            starting_price_far=(values["starting_price_far"] if values["starting_price_far"] else None),
        )
