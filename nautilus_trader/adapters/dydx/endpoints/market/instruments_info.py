...
class DYDXPerpetualMarketResponseObject(msgspec.Struct, forbid_unknown_fields=True):
    ...
    openInterest: str
    atomicResolution: float
    quantumConversionExponent: float
    tickSize: str
    stepSize: str
    stepBaseQuantums: float
    subticksPerTick: float
    ...
    def parse_to_instrument(
        ...
        instrument_id = DYDXSymbol(raw_symbol.value).parse_as_nautilus()
